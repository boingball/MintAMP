...
#include "types.h"
/* fixmul32b (used directly by wmadeci.c and wmafixed.h) and
 * ff_imdct_calc/ff_imdct_half (used by wmadeci.c) live in mdct.h; the real
 * Rockbox codeclib.h pulls this in transitively for every codec, but this
 * project's minimal codeclib.h stand-in deliberately doesn't, so pull it
 * in here instead -- both wmadeci.c and wmafixed.c include wmadec.h first,
 * before anything that needs these declarations. */
#include "mdct.h"
